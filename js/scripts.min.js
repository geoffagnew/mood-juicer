...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var rn=e.jQuery,on=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=on),t&&e.jQuery===ie&&(e.jQuery=rn),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(function(){function e(e){var t=Math.floor(Math.random()*e);return t}function t(t){for(u=e(a);t===u;)u=e(a);return u}function n(e){l=e}function r(){var t=e(s),n=o[t],r=$("body");r.toggleClass(n);var i=r.attr("class");r.hasClass(i)?(r.removeClass(i),r.addClass(n)):r.addClass(n)}var i=["https://www.youtube.com/embed/Yt6Ig18C8dA","https://www.youtube.com/embed/-F5HwiGm7lg","https://www.youtube.com/embed/W6p2onuGlpo","https://www.youtube.com/embed/U5aqQvEeMro","https://www.youtube.com/embed/dzt7oCFN3ek"],o=["red","orange","green","purple"],a=i.length,s=o.length,l="",u="",c=$("#video-output"),d=$("#boost-btn");d.on("click",function(e){e.preventDefault(),d.hasClass("first")&&(d.removeClass("first"),d.text("Another video please")),$("#text-wrap").hasClass("launch")&&$("#text-wrap").removeClass("launch"),r(),c.hasClass("hide")&&c.removeClass("hide");var o=t(l),a=i[o];a+="?autoplay=1",$("#video-output iframe").attr("src",a),n(u)})});