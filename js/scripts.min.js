...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var rn=e.jQuery,on=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=on),t&&e.jQuery===ie&&(e.jQuery=rn),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(function(){function e(e,r){for(var i=e;i===r;)i=t();var o=n(i),a=[o,i];return a}function t(){var e=i.length,t=Math.floor(Math.random()*e);return t}function n(e){var t=i[e];return t}function r(e){o=e}var i=["https://www.youtube.com/embed/Yt6Ig18C8dA=ONE","https://www.youtube.com/embed/-F5HwiGm7lg=TWO","https://www.youtube.com/embed/W6p2onuGlpo=THREE"],o="Empty",a="";$("#boost-btn").on("click",function(n){n.preventDefault(),$("#test-block-previous").html("This is the previous number: "+o);var i=t(),s=e(i,o);$("#test-block").html("This is the current url: "+s[0]),$("#test-block-current").html("This is the current number selected: "+s[1]),a="Current url: "+s[0]+"<br />Current number: "+s[1]+"<br />Previous number: "+o,console.log(a),r(i)})});