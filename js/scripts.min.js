...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var rn=e.jQuery,on=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=on),t&&e.jQuery===ie&&(e.jQuery=rn),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(function(){function e(e){var t=Math.floor(Math.random()*e);return t}function t(){if(r.length<=1){var t=r.length,n=r[0];t=r.length,r=i.slice(),i=[],i.push(n)}else{var t=r.length,o=e(t),n=r[o];r.splice(o,1),i.push(n),t=r.length}return[n,t]}function n(){var t=e(a),n=o[t],r=$("body");r.toggleClass(n);var i=r.attr("class");r.hasClass(i)?(r.removeClass(i),r.addClass(n)):r.addClass(n)}var r=["one","two","three","four","five"],i=[],o=["red","orange","green","purple"],a=o.length,s=$("#video-output"),l=$("#boost-btn");l.on("click",function(e){e.preventDefault(),l.hasClass("first")&&(l.removeClass("first"),l.text("Another video please")),$("#text-wrap").hasClass("launch")&&$("#text-wrap").removeClass("launch"),n(),s.hasClass("hide")&&s.removeClass("hide");var o=t();o[0];console.log("NEW GROUP --\nOriginal videos array: "+r),console.log("Second videos array: "+i),console.log("Number of videos left in original array: ------------ "+o[1]),console.log("This is the selected url for display: ------------ "+o[0])})});